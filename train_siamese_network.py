...
def main():
    ...
    tensorboard_log_path = './logs/siamese_net_ts_11'
    general_output_file_path = './logs/siamese_net_ts_txt_11/'
    model_name = 'siamese_net_ts_11'
    ...
    print(siamese_network.model.layers)
    ...
    if validation_accuracy == 0:
        ...
        siamese_network.model.load_weights('models/siamese_net_ts_9.h5')
