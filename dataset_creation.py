...
def main():
    general_output_path = './logs/bayesian_color_2/'
    ...
    def bayesian_optimization_function(x):
        ...
        model_name = 'siamese_net_ts_bay_color2_lr' + str(current_learning_rate) + \
                     'momentum_' + str(current_momentum) + '_slope_' + \
                     str(current_momentum_slope)

        global current_model_number
        current_model_number += 1
        tensorboard_log_path = './logs/bayesian_color_2/' + str(current_model_number)
        ...
        siamese_network = SiameseNetwork(
            ...
            batch_size=32, use_augmentation=False,
        ...
        support_set_size = 20
        evaluate_each = 48000
        number_of_train_iterations = 50000
